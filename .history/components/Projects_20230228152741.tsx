...
function Projects({}: Props) {
    ...
    return (
        <motion.div className='h-screen relative flex overflow-hidden flex-col text-left md:flex-row max-w-full justify-evenly
                ...
                z-20'>
                    {projects.map((project, i) => (
                        ...
                        <div className='space-y-10 px-0 md:px-10 max-w-6xl '>
                            ...
                            <p className='text-lg text-center md:text-left '>Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
