    ...
    return (
        ...
        className='flex flex-col relative h-screen text-center
            ...
            <div className='space-y-10 px-0 md:px-10'>
                ...
                <p className='text-lg text-gray-500'> As a App/Web3 Developer new in the industry, I am a recent graduate with a solid understanding of front-end and back-end web development, as well as experience with blockchain and smart contract development. I am passionate about building scalable, user-friendly applications that meet real-world needs.
