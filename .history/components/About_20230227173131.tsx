...
function About({}: Props){
    return (
        ...
        className='flex flex-col relative h-screen text-center
                    ...
                    <h3 className='absolute top-24 uppercase tracking-widest text-gray-500 text-2xl animate-pulse'>About
                    </h3>
            ...
            <div className='space-y-10 px-0 md:px-10'>
                <h4 className='text-4xl font-semibold'>Here is a <span className='underline decoration-[#0ae3f7]/50'>little</span> about me
                </h4>
